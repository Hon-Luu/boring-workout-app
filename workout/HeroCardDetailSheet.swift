    ...
    private var heroHeader: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 0) {
                ...
                Divider().frame(height: 28)
                statChip(momentumArrow, "Momentum")
            }
            .padding(.vertical, 14)
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 12) {
                pillarCard(
                    ...
                    description: "How close your current lifts are to your personal best, and your strength load relative to body weight.",
                    subScores: [
                ...
                pillarCard(
                    ...
                    description: "Your rate of improvement across exercises over recent sessions. The biggest driver of your score.",
                    subScores: []
                )
                ...
                pillarCard(
                    ...
                    description: "Training quality — how close to failure you work, your rep efficiency, and how well you manage fatigue.",
                    subScores: [
