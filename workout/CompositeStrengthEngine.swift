...
enum CompositeStrengthEngine {
    ...
    private static func scoreToGrade(_ score: Double) -> (grade: String, color: String) {
        ...
        case 50..<60: return ("Recovering", "orange")
    ...
    private static func generateInsight(
        ...
        case "process":
            ...
            if let eff = effSub, eff < 40 {
                return "Rep efficiency is \(Int(eff))/100 — you're accumulating volume but strength gains aren't matching effort. Shift to fewer, heavier sets with 3–5 min rest to improve yield."
            }
