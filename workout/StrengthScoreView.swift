    ...
    var body: some View {
        VStack(spacing: 12) {
            Picker("", selection: $mode) {
                ForEach(availableModes, id: \.self) { m in Text(m.rawValue).tag(m) }
            }
...
private struct SSCompositeCard: View {
    ...
    private var historyChart: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            // Score legend
            HStack(spacing: 10) {
                ForEach([("Peak","purple"),("Strong","green"),("Solid","blue"),("Building","yellow"),("Recovering","orange")], id: \.0) { label, c in
                    HStack(spacing: 3) {
